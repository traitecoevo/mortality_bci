get_model_chunks <- function(tasks) {
  ...
  list(
    ...
    parameters = sprintf("
      ...
      real<lower=0> a0[n_spp];
      real mu_log_a0;
      real<lower=0> sigma_log_a0;
      
      real<lower=0> a1[n_census];
      real<lower=0> sigma_log_a1;
      
      real<lower=0> b0[n_spp];
      real mu_log_b0;
      real<lower=0> sigma_log_b0;
      
      real<lower=0> b1[n_census];
      real<lower=0> sigma_log_b1;
      
      real<lower=0> c0[n_spp];
      real mu_log_c0;
      real<lower=0> sigma_log_c0;
      
      real<lower=0> c1[n_census];
