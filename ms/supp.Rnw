...
\clearpage
\section{Appendix 2 - Example stan code}

Include example model here

Describe how to get other models?
...
\begin{figure}[!hb]
\centering
\includegraphics[width=15cm,height=20cm,keepaspectratio]{figures/supp_fig1}
\caption{ About this figure}
\label{figS1}
\end{figure}
...
\begin{figure}[!hb]
\centering
\includegraphics[width=15cm,height=20cm,keepaspectratio]{figures/supp_fig2}
\caption{ About this figure}
\label{figS2}
\end{figure}
