...
The section ``Review of methods for estimating mortality'' 
...
\caption{Pairwise comparison between species' wood density, light demand and maximum dbh.}
\label{figS6}
\end{figure*}
\end{document}
