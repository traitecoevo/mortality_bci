...
\dropcap{R}ates of plant mortality are known to be highly variable among coexisting species, between forests and from year-to-year \cite{Kobe:1995tw,Wyckoff:2002ul,Poorter:2008iu}. This variation has considerable consequences for forest structure and dynamics. For example, death of a single large tree can transfer up to 20000 kg of carbon from living to decaying carbon pools\cite{Chave:2005hz}. Furthermore it creates a gap in the canopy that can restart a successional race, during which 100's-1000's more plants may die while competing for a spot in the sun. In models of forest dynamics, variation in mortality rates has been shown to have a larger impact on forest structure than variation in absolute growth rates\cite{Johnson-2016}. As such, improving our ability to understand the mortality process is a priority for making accurate predictions about forest and carbon dynamics as well as water or nutrient cycles; especially in an era of rapid environmental change.
...
\caption{Proportion of predicted variation in 5-year survival explained by different covariates.
A) Wood density (grey) as well as species and census random effects.
B) Growth-dependent and growth-independent (baseline) hazards.}
\label{fig5}
\end{figure}
...
Whether the length between censuses affect the estimation of growth-dependent and growth-independent hazards should also be examined. Large census intervals may lead to underestimation of growth-dependent mortality, and consequently, overestimate the relative contribution of growth-independent hazards. This is because if a census interval is too wide, it will fail to account for deaths attributed to rapid declines in growth caused by senescence (especially for short-lived plants) or events such as drought. Because our analysis estimated an individual's past growth from 5 year census intervals, and because it included short-lived species (i.e. those with high annual mortality rates; see Fig. \ref{fig4}) and a drought period between 1995 and 2000, our estimates of growth-dependent and growth-independent hazards are likely to be biased.

Lastly, research should also examine how different growth measures alter the predictive skill of mortality models. We found that DBH growth outperformed basal area growth in terms of model predictive skill, but have as yet no clear explanation as to why, or how other common measures such as biomass growth\cite{Chave:2005hz} will compare.
