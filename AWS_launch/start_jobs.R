...
#                      path="/home/data")
# # queue the jobs
# res <- enqueue_bulk(growth_tasks, model_compiler, obj, progress_bar = TRUE)
...
rho_tasks <- tasks_2_run(analysis = 'rho_combinations',iter = 1000, 
                     ...
                     path="/home/data")
res <- enqueue_bulk(rho_tasks, model_compiler, obj, progress_bar = TRUE)
...
null_tasks <- tasks_2_run(analysis = 'null_model',iter = 1000, 
                     growth_measure = 'true_dbh_dt',
                     path="/home/data")
res <- enqueue_bulk(null_tasks, model_compiler, obj, progress_bar = TRUE)

# NULL MODEL VARIES BY SPECIES ID
null_re_tasks <- tasks_2_run(analysis = 'null_model_random_effects',iter = 1000, 
                     growth_measure = 'true_dbh_dt',
                     path="/home/data")
res <- enqueue_bulk(null_re_tasks, model_compiler, obj, progress_bar = TRUE)
...
no_gamma_tasks <- tasks_2_run(analysis = 'no_gamma_model',iter = 1000, 
                     growth_measure = 'true_dbh_dt',
                     path="/home/data")
res <- enqueue_bulk(no_gamma_tasks, model_compiler, obj, progress_bar = TRUE)
...
no_gamma_re_tasks <- tasks_2_run(analysis = 'no_gamma_model_random_effects',iter = 1000, 
                     growth_measure = 'true_dbh_dt',
                     path="/home/data")
res <- enqueue_bulk(no_gamma_re_tasks, model_compiler, obj, progress_bar = TRUE)
