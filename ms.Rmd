...
Understanding who lives or dies, and why, is critical to predicting population, community and ecosystem dynamics [@Hawkes:2000ib; @McDowell:2011dr]. In plants, the carbon budget is considered a fundamental determinant of mortality, such that if rates of carbon assimilation are low or become insufficient for growth, an individual has a higher probability of dying [@Peet:1987va; @Hawkes:2000ib; @Keane:2001db; @McDowell:2011dr]. Empirical studies examining intraspecific mortality have broadly supported this assumption, with many finding that probability of death declines exponentially with increasing growth rates [@Buchman:1983vx; @Kobe:1997vy; @Wyckoff:2002ul; @Mantgem:2003dw]. Consequently, most dynamic vegetation models, including tree gap models [@Botkin:1972ii; @Keane:2001db], individual-based forest simulators (e.g. SORTIE; REF) and Dynamic Global Vegetation Models (DGVM's; @Woodward:2004ft) use this growth-mortality relationship as the predominant, and in some cases, only mechanism describing plant mortality [@Hawkes:2000ib; @McDowell:2011dr]. 


However, many dynamic vegetation models assume the growth-mortality relationship is constant across species. This is despite empirical evidence highlighting that mortality rates vary considerably between species. In contrast to intraspecific studies, multispecies studies have shown that species with intrinsically faster growth rates exhibit higher mortality rates relative to slower growing species [@Poorter:2008iu; @Wright:2010fl]. Ecologists have attempted to explain this interspecific variation by using functional traits - attributes of species that are thought to influence vital rates (i.e. survival, growth and reproduction) and ultimately fitness [@Ackerly:2003eb; @Poorter:2008iu]. Wood density, the biomass invested per unit wood volume, is one such functional trait that has been consistently shown to be negatively correlated with tropical tree mortality [@Chave:2009iy; @Nascimento:2005wx; @King:2006he; @AlvarezClare:2007gv; @Chao:2008hg; @Poorter:2008iu; @Kraft:2010kq; @Wright:2010fl]. The underlying mechanism of this relationship is thought to be due to denser wood conveying enhanced physical resistance to stem breakage [@Putz:1983wu; @vanGelder:2006ex; @Chave:2009iy], wood herbivory (NEED REF), embolism [@Hacke:2001kj, @Jacobsen:2005fx, @Preston:2006jn] and fungal and pathogen attack [@Augspurger:1984wx]. However, research has also shown that wood density may increase survival associated with growth-dependent mortality. For example, species with high wood density are often more shade tolerant, [ADD something about competitition from Kunstler et al Nature paper] and thus exhibit a lower probability of dying at low growth rates [e.g. @vanGelder:2006ex]. Studies have also shown that wood density may reduce drought induced carbon starvation [@McDowell:2011dr] and the susceptibility of ‘stressed’ individuals to opportunistic invertebrate, pathogen or fungal attack [@Augspurger:1984wx; @McDowell:2011dr].


To date, researchers have examined plant mortality by: 1) using individual based covariates (e.g. growth, size) within species [e.g. @Kobe:1997vy]; or 2) examining correlations between population level estimates of plant mortality (e.g. Wright et al 2010, Chave et al 2004). However, there has been little crossover of ideas between these two research focuses. For example, as far as we are aware, no study has examined how functional traits mediate the negative exponential relationship between growth and mortality. Furthermore, some fundamental questions have yet to be answered such as whether an area or diameter based growth rate better predicts plant mortality. Lastly, we are unaware of any attempt to partition plant mortality into growth

Lastly, we are unaware of a model that attempts to simultaneously estimat 

Lastly, we are unaware of a model that attempts because most plant mortality data is binary (i.e. alive/dead), 


there has been there have been few attempts to partition mortality into growth related and stochastic



 little consideration has been given to whether an area or diameter based growth rate better predicts plant mortality. This is despite both individual (e.g. growth rates) and species (e.g. function traits) characteristics likely to be required in order to develop an accurate and general model of how the growth effects plant mortality. Furthermore, both research focuses have used

In this study, we reconcile both research focuses by using 15-years of growth and mortality data from 203 tropical rainforest species encompassing more than 180,000 individuals in a Bayesian hierarchical model that explicitly accounts for variability observed both within and between species. Specifically, our model uses the negative exponential growth-mortalty relationship commonly observed and fitted in intraspecific studies and extends this by both adding a growth-independent baseline hazard, and by allowing each parameter to vary as a function of species level traits (in this case wood density).
