...
generated quantities {
  ...
  for (i in 1:n_obs) {
    alpha_fit <- a0[spp[i]] * a1[census[i]] * pow(rho_c[spp[i]], a2);
    beta_fit <- b0[spp[i]] * b1[census[i]] * pow(rho_c[spp[i]], b2);
    gamma_fit <- c0[spp[i]] * c1[census[i]] * pow(rho_c[spp[i]], c2);
  ...
  for (j in 1:n_obs_heldout) {
    alpha_heldout <- a0[spp_heldout[j]] * a1[census_heldout[j]] * pow(rho_c_heldout[spp_heldout[j]], a2);
    beta_heldout <- b0[spp_heldout[j]] * b1[census_heldout[j]] * pow(rho_c_heldout[spp_heldout[j]], b2);
    gamma_heldout <- c0[spp_heldout[j]] * c1[census_heldout[j]] * pow(rho_c_heldout[spp_heldout[j]], c2);
