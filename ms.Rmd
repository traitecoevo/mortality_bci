...
source('R/utils.R')
load('output/rho_stan_model.rda')
library(rstan)
```
...
print(stan_model,probs = c(0.025,0.975), digits_summary = 3)
```

```{r Coefficient plot, fig.height=6,fig.width=6, echo=FALSE}
coeff_plot(stan_model, params=c('c1','c0_mu','b1','b0_mu','a1','a0_mu'),
...
plot_mortality(model_fit = stan_model ,model_data = stan_data, cov_name = 'rho',
